...
El alumnado somete el gestor de tareas y sus informes a una estrategia de pruebas reproducible. La IA ayuda a proponer casos y configurar pruebas; el alumnado identifica preparación, acción y resultado esperado, las ejecuta desde interfaces visuales, conserva evidencias, diagnostica fallos y comprueba la corrección.
...
3. Pedir a Gemini/AI Studio un caso o una configuración pequeña y explicada.
...
- **Gemini / Google AI Studio:** generación y explicación de casos, datos y configuraciones delimitadas.
- **Grabador y panel visual de pruebas web:** integración y regresión de flujos ejecutados en navegador.
- **Chrome DevTools y Lighthouse:** red, rendimiento, memoria, accesibilidad y uso de recursos.
- **Panel visual de carga:** volumen y estrés sobre una copia autorizada, con escenarios pequeños configurados mediante formularios.
- **Auditoría de seguridad del navegador o servicio visual autorizado:** revisión pasiva inicial; nunca sustituye la comprobación manual.
